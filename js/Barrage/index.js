let data=[
  ...
  {value:'666',time:10,color:'black',speed:1,fontSize:22},
  {value:'疯狂打Call',time:12,color:'green',speed:1,fontSize:22}
];
  ...
  class Barrage{
    ...
    // 把 obj和ctx都挂载到this上，方便获取
    this.obj=obj;
    this.context=ctx;
    }
    // 初始化弹幕
    init(){
      // 如果数据没有涉及到下面四钟参数，就直接取默认参数
      this.color=this.obj.color||this.context.color;
      this.speed=this.obj.speed||this.context.speed;
      this.opacity=this.obj.opacity||this.context.opacity;
      this.fontSize=this.obj.fontSize||this.context.fontSize;
      // 为了计算每个弹幕的宽度，我们创建一个元素p，然后计算文字的宽度
